...
?>
<form action="papacut_1write_result.php" method="post" name="form" enctype="multipart/form-data" >
<div>
<ul>
<li>
...
<li><input type="radio" name="ok" checked="checked"/>동의 <input type="radio" name="ok"/>동의하지 않음</li>
</ul>
<ul>
<li>제목</li>
<li><input type="text" name="subject" /></li>
<li><input type="radio" name="onoff" value="공개" checked="checked" />공개 <input type="radio" name="onoff" value="비공개" />비공개</li>
</ul>
<ul>
<li>카테고리</li>
<li>
...
<ul>
<li><input type="button" value="글쓰기" onclick="writed()" /><input type="button" value="목록보기" onclick="location.href='papacut_list.php" /></li>
</ul>
</div>
</form>
<? } ?>
