...
<table width="993" cellpadding="0" cellspacing="0">
    <tr>
        <td width="241" rowspan="2"><img src="./cut/img/<?=$fetch['image']?>" width="100" /</td>
        <td width="241">제목 : <a href="papa<?=$board?>view.php?no=<?=$no?>"><?=$fetch['subject']?></a></td>
        <td width="241">글쓴이 : <?=$fetch['cutid']?></td>
