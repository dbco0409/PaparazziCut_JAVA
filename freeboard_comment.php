...
$sql2="select cmtno from cmt_free where no='$no'";
...
$sql="insert into cmt_free (no, name, text, date, cmtno) values('$no','$name','$text','$date', '$cno')";
$query=mysql_query($sql, $connect);

if($query){
?>
<script type="text/javascript">
location.href='freeboard_view.php?no=<?=$no?>';
</script>
<?
} else {
?>
