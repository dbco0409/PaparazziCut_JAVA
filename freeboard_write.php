...
$sql="select ctg from menu where menuid='board_5'";
...
?>
<div>
<form action="freeborad_result.php" method="post" name="form">
...
<tr>
<td colspan="2" align="center"><input type="button" value="글쓰기" onclick="writeChk()"/><input type="button" value="목록보기" onclick="location.href='freeboard_list.php'" /></td>
</tr>
</table> 
</form>
</div>
