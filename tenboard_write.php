...
$sql="select ctg from menu where menuid='board_2'";
...
?>
<div>
<form action="tenborad_result.php" method="post" name="form">
...
<tr>
<td colspan="2" align="center"><input type="button" value="글쓰기" onclick="writeChk()"/><input type="button" value="목록보기" onclick="location.href='tenboard_list.php'" /></td>
</tr>
</table> 
</form>
</div>
