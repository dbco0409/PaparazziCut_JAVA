...
$sql2="select cmtno from cmt_twenty where no='$no'";
...
$sql="insert into cmt_twenty (no, name, text, date, cmtno) values('$no','$name','$text','$date', '$cno')";
$query=mysql_query($sql, $connect);

if($query){
?>
<script type="text/javascript">
location.href='twentyboard_view.php?no=<?=$no?>';
</script>
<?
} else {
?>
