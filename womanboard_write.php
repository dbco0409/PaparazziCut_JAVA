...
$sql="select ctg from menu where menuid='board_3'";
...
?>
<div>
<form action="womanborad_result.php" method="post" name="form">
...
<tr>
<td colspan="2" align="center"><input type="button" value="글쓰기" onclick="writeChk()"/><input type="button" value="목록보기" onclick="location.href='womanboard_list.php'" /></td>
</tr>
</table> 
</form>
</div>
