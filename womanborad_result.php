...
$sql2="select no from board_woman";
...
$sql="insert into board_woman (no, id, name, ctg, homepage, subject, text, date, hit) values('$no','$id','$name','$ctg','$homepage','$subject','$text','$date', '$hit')";
